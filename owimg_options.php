...
/* STOCKER LES DOCUMENTS INCONNUS AU FORMAT .ZIP */
		...
		// Ici le changement OpenWeb : le premier argument n'est pas $ext mais construit à partir de l'id de l'article...
		$dest = $type_lien.$id_lien;
		$fichier = copier_document($dest, $nom_envoye, $source);
		if (!$fichier) {
			spip_log("Impossible de copier_document($dest, $nom_envoye, $source)");
			return;
		}
